...
dlmwrite('ANSYS_B_avg_HT0_0A_CC.csv',[tm BaveHT0])
dlmwrite('ANSYS_Iext_0A_CC.csv',[tm I0])
dlmwrite('ANSYS_Ld_0A_CC.csv',[tm dLL])
dlmwrite('ANSYS_phi_0A_CC.csv',[tm flux])
