...
%read in power vs. t (with batch it needs to skip 14 lines)
Pin = readData('power1.txt',14);
Vin = readData('voltage1.txt',14);
Iin = readData('current1.txt',14);
...
dlmwrite('circu_res.txt',[tm I1 V1 VR VS]);
