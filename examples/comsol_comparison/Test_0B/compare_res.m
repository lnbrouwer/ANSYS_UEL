...
sBave = importdata('..\CERN_res\0B\B_avg_HT0_0B.csv');
sIext= importdata('..\CERN_res\0B\Iext_0B.csv');
sdatLd = importdata('..\CERN_res\0B\Ld_0B.csv');
sdatPhi = importdata('..\CERN_res\0B\phi_0B.csv');
