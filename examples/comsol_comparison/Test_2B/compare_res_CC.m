...
dlmwrite('ANSYS_Q_avg_HT0_2B_CC.csv',[tm JsumHT0])
dlmwrite('ANSYS_Q_tot_2B_CC.csv',[tm JALL])
dlmwrite('ANSYS_rho_avg_HT0_2B_CC.csv',[tm rhoHT0])
dlmwrite('ANSYS_T_avg_HT0_2B_CC.csv',[tm TaveHT0])
