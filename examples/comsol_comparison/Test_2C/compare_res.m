...
dlmwrite('ANSYS_Q_avg_HT0_2C.csv',[tm JsumHT0])
dlmwrite('ANSYS_Q_tot_2C.csv',[tm JALL])
dlmwrite('ANSYS_rho_avg_HT0_2C.csv',[tm rhoHT0])
dlmwrite('ANSYS_T_avg_HT0_2C.csv',[tm TaveHT0])
