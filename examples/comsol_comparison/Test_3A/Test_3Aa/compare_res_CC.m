...
rhocuHT0_cern = importdata('..\..\CERN_res\3Aa\rhocu_avg_HT0_3Aa.csv');
rhoHT0_cern = importdata('..\..\CERN_res\3Aa\rho_avg_HT0_3Aa.csv');
temHT0_cern = importdata('..\..\CERN_res\3Aa\T_avg_HT0_3Aa.csv');
tauHT0_cern = importdata('..\..\CERN_res\3Aa\tau_avg_HT0_3Aa.csv');
...
% 
dlmwrite('ANSYS_B_avg_HT0_3Aa_CC.csv',[tm,BHT0])
dlmwrite('ANSYS_temp_avg_HT0_3Aa_CC.csv',[tm,temHT0])
dlmwrite('ANSYS_tau_avg_HT0_3Aa_CC.csv',[tm,tauHT0])
dlmwrite('ANSYS_rhocu_avg_HT0_3Aa_CC.csv',[tm,rhocuHT0])
dlmwrite('ANSYS_rho_avg_HT0_3Aa_CC.csv',[tm,rhoHT0])
