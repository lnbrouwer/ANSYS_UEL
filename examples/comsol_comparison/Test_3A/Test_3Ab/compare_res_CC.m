...
% 
dlmwrite('ANSYS_B_avg_HT0_3Ab_CC.csv',[tm,BHT0])
dlmwrite('ANSYS_temp_avg_HT0_3Ab_CC.csv',[tm,temHT0])
dlmwrite('ANSYS_tau_avg_HT0_3Ab_CC.csv',[tm,tauHT0])
dlmwrite('ANSYS_rhocu_avg_HT0_3Ab_CC.csv',[tm,rhocuHT0])
dlmwrite('ANSYS_rho_avg_HT0_3Ab_CC.csv',[tm,rhoHT0])
