...
% 
dlmwrite('ANSYS_B_avg_HT0_3Ac.csv',[tm,BHT0])
dlmwrite('ANSYS_temp_avg_HT0_3Ac.csv',[tm,temHT0])
dlmwrite('ANSYS_tau_avg_HT0_3Ac.csv',[tm,tauHT0])
dlmwrite('ANSYS_rhocu_avg_HT0_3Ac.csv',[tm,rhocuHT0])
dlmwrite('ANSYS_rho_avg_HT0_3Ac.csv',[tm,rhoHT0])
