...
dlmwrite('ANSYS_I_4A.csv',[tm I0])
dlmwrite('ANSYS_ind_4A.csv',[tm LL])
dlmwrite('ANSYS_phi_4A.csv',[tm flux])
dlmwrite('ANSYS_Edump_4A.csv',[xint' QR'])
...
I0M_cern  = importdata('..\CERN_res\4A\Iext_4A.csv');
flux_cern = importdata('..\CERN_res\4A\phi_4A.csv');
Edump_cern = importdata('..\CERN_res\4A\Edump_4A.csv');
LL_cern = importdata('..\CERN_res\4A\L_4A.csv');
...
set(gca,'FontSize',16,'linewidth',2)
set(h(fnum),'Position', [200 200 850 600])
legend('4A ANSYS','4A COMSOL','0B ANSYS','Location','NorthEastOutside')
set(gcf,'PaperPositionMode','auto')
...
title(tag)
xlabel('tm (s)','FontSize',18)
ylabel('Qtot HT0 - quad (W/m)','FontSize',18)
set(gca,'FontSize',16,'linewidth',2)
set(h(fnum),'Position', [200 200 850 600])
legend('ANSYS','COMSOL','Location','NorthEastOutside')
set(gcf,'PaperPositionMode','auto')
...
title(tag)
xlabel('tm (s)','FontSize',18)
ylabel('Qtot all  - quad  (W/m)','FontSize',18)
set(gca,'FontSize',16,'linewidth',2)
set(h(fnum),'Position', [200 200 850 600])
legend('ANSYS','COMSOL','Location','NorthEastOutside')
set(gcf,'PaperPositionMode','auto')
