...
dlmwrite('ANSYS_I_4E.csv',[tm I0])
dlmwrite('ANSYS_ind_4E.csv',[tm LL])
dlmwrite('ANSYS_phi_4E.csv',[tm flux])
dlmwrite('ANSYS_Edump_4E.csv',[xint' QR'])
dlmwrite('ANSYS_Eifcc_4E.csv',[xint' QIFCC'])
dlmwrite('ANSYS_tauHT0_4E.csv',[tm tauHT0])
dlmwrite('ANSYS_MxHT0_4E.csv',[tm MxHT0])
dlmwrite('ANSYS_MyHT0_4E.csv',[tm MyHT0])
dlmwrite('ANSYS_QifccHT0_4E.csv',[tm PtauHT0])
dlmwrite('ANSYS_QifccTOT_4E.csv',[tm PtauSUM])
dlmwrite('ANSYS_Tave_HT0_4E.csv',[tmT TaveHT0])
dlmwrite('ANSYS_Ecoil_4E.csv',[xint' QRES'])
dlmwrite('ANSYS_QresHT0_4E.csv',[tm PresHT0])
dlmwrite('ANSYS_QresTOT_4E.csv',[tm PresSUM])
dlmwrite('ANSYS_Rcoil_4E.csv',[tm Rcoil])

I0M_cern  = importdata('..\CERN_res\4E\Iext_4E.csv');
LL_cern  = importdata('..\CERN_res\4E\L_4E.csv');
flux_cern  = importdata('..\CERN_res\4E\phi_4E.csv');
Edump_cern  = importdata('..\CERN_res\4E\Edump_4E.csv');
PresHT0_cern  = importdata('..\CERN_res\4E\Q_res_tot_HT0_4E.csv');
PresSUM_cern  = importdata('..\CERN_res\4E\Q_res_tot_4E.csv');
Rcoil_cern  = importdata('..\CERN_res\4E\R_tot_4E.csv');
tauHT0_cern  = importdata('..\CERN_res\4E\tau_avg_HT0_4E.csv');
MxHT0_cern  = importdata('..\CERN_res\4E\M_ifccx_avg_HT0_4E.csv');
MyHT0_cern  = importdata('..\CERN_res\4E\M_ifccy_avg_HT0_4E.csv');
PtauHT0_cern  = importdata('..\CERN_res\4E\Q_ifcc_tot_HT0_4E.csv');
PtauSUM_cern  = importdata('..\CERN_res\4E\Q_ifcc_tot_4E.csv');
TaveHT0_cern  = importdata('..\CERN_res\4E\T_avg_HT0_4E.csv');
...
title(tag)
xlabel('tm (s)','FontSize',18)
ylabel('Q iffc HT0 - quad  (W/m)','FontSize',18)
set(gca,'FontSize',16,'linewidth',2)
set(h(fnum),'Position', [200 200 850 600])
legend('ANSYS','COMSOL','Location','NorthEastOutside')
set(gcf,'PaperPositionMode','auto')
...
title(tag)
xlabel('tm (s)','FontSize',18)
ylabel('Q iffc total - quad (W/m)','FontSize',18)
set(gca,'FontSize',16,'linewidth',2)
set(h(fnum),'Position', [200 200 850 600])
legend('ANSYS','COMSOL','Location','NorthEastOutside')
set(gcf,'PaperPositionMode','auto')
...
set(gca,'FontSize',16,'linewidth',2)
set(h(fnum),'Position', [200 200 850 600])
legend('4E ANSYS','4E COMSOL','0B','Location','NorthEastOutside')
set(gcf,'PaperPositionMode','auto')
