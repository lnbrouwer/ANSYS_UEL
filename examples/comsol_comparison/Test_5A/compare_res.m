...
sBave = importdata('..\CERN_res\5A\B_ave_HT0_5A.csv');
sIext= importdata('..\CERN_res\5A\Iext_5A.csv');
sdatLd = importdata('..\CERN_res\5A\Ld_5A.csv');
sdatPhi = importdata('..\CERN_res\5A\phi_5A.csv');
...
legend('ANSYS','COMSOL','Location','NorthEastOutside')
set(gcf,'PaperPositionMode','auto')
print(h(fnum),'-djpeg',['LL_vs_I_',tag],'-r300')
hold off


dlmwrite('ANSYS_B_avg_HT0_5A.csv',[tm BaveHT0])
dlmwrite('ANSYS_Iext_5A.csv',[tm I0])
dlmwrite('ANSYS_Ld_5A.csv',[tm dLL])
dlmwrite('ANSYS_phi_5A.csv',[tm flux])
dlmwrite('ANSYS_LL_vs_I_5A.csv',[I0 LL])
return 
