...
dat2 = importdata('../Test_5B/user102/circu_res.txt');
I2 = abs(dat2(:,2));
dat = importdata('../Test_5B/user102/Mag_v_t.txt');
tm2 = dat(:,1);

dat3 = importdata('../Test_5C/user102/circu_res.txt');
I3 = abs(dat3(:,2));
dat = importdata('../Test_5C/user102/Mag_v_t.txt');
tm3 = dat(:,1);
